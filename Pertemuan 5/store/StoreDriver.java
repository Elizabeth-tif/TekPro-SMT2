...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (sc.hasNext()) {
            ...
            } else if (employeeType.equals("Delivery")) {
                int efficiency = sc.nextInt();
                int totalTask = sc.nextInt();
                
                Delivery delivery = new Delivery(numberOfHoursWorked, hourlyRate, storeDetails, basePay, empName, efficiency, totalTask);
        ...
        for (Manager manager : managerList) {
            ...
            System.out.print( manager.getEmployeeName() + " get a bonus of $" + manager.bonus()); // abstract method
            // interface method
            System.out.print("\nTax cut " + manager.getEmployeeName() + " pay is $"+ manager.pajak());
            
            System.out.print("\nShould " + manager.getEmployeeName() + " be fired?\n");
            if (manager.fired()) {
                System.out.println("Yes, he/she need to be fired \n");
            } else {
                System.out.println("No, he/she should not be fired\n");
            }
        ...
        System.out.println("******************************************************");
        System.out.println("Number of employees working as DELIVERY are: " + deliveryList.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as DELIVERY are: " + deliveryList.size());
        pwd.println("******************************************************");
        for (Delivery delivery : deliveryList) {
            deliveryCount++;
            System.out.println(deliveryCount + ". Delivery Details:");
            System.out.println(delivery);
            pwd.println(delivery);
            System.out.println("Payment: $" + delivery.calculatePay());
            
            pwd.println("Payment: $" + delivery.calculatePay());
            System.out.print("Is " + delivery.getEmployeeName() + " eligible for promotion? ");
            if (delivery.checkPromotionEligibility()) {
                System.out.println("Yes, he/she is eligible\n");
            } else {
                System.out.println("No, he/she needs to work harder\n");
            }

            System.out.println( delivery.getEmployeeName() + " get a bonus of $" + delivery.bonus()); // abstract method
            // interface method
            System.out.println("Tax cut " + delivery.getEmployeeName() + " pay is $"+ delivery.pajak());
            
            System.out.println("Should " + delivery.getEmployeeName() + " be fired?");
            if (delivery.fired()) {
                System.out.println("Yes, he/she need to be fired \n");
            } else {
                System.out.println("No, he/she should not be fired\n");
        ...
        for (SalesAssociate salesAssociate : salesAssociateList) {
            ...
            System.out.println( salesAssociate.getEmployeeName() + " get a bonus of $" + salesAssociate.bonus()); // abstract method
            // interface method
            System.out.println("Tax cut " + salesAssociate.getEmployeeName() + " pay is $"+ salesAssociate.pajak());
            
            System.out.println("Should " + salesAssociate.getEmployeeName() + " be fired?");
            if (salesAssociate.fired()) {
                System.out.println("Yes, he/she need to be fired \n");
            } else {
                System.out.println("No, he/she should not get fired\n");
            }
        }
